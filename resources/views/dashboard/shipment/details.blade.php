                    ...
                    <div class="card mb-4">
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" value="{{ $shipment->sender_address }}" class="form-control" disabled
                                    readonly>
                            </div>
                            <div class="form-group">
                                <label>Sender's Contact:</label>
                                <input type="text" value="{{ $shipment->sender_contact }}" class="form-control" disabled
                                    readonly>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="card mb-4">
                        ...
                        <div class="card-body">
                            <div class="form-group">
                                ...
                                <input type="text" value="{{ $shipment->receiver_name }}" class="form-control" disabled
                                    readonly>
                            </div>
                            <div class="form-group">
                    ...
                    <div class="card mb-4">
                        ...
                        <div class="card-body">
                            <div class="form-group">
                                ...
                                <input type="text" value="{{ $shipment->tracking_number }}" class="form-control" disabled
                                    readonly>
                            </div>
                            <div class="card mb-4">
                                <div class="card-header">
                                            ...
                                            <table class="table table-bordered">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>{{ $shipment->courier->contact_number }}</td>
                                                        <td>{{ $shipment->courier->vehicle_type }}</td>
                                                        <td>{{ $shipment->courier->license_plate ?? 'Not Available' }}
                                                        </td>
                                                    </tr>

    ...
    <div class="main-content">
        <div class="section__content section__content--p30">
            <div class="container-fluid">
                ...
                <form action="{{ route('dashboard.shipment.courier.store') }}" enctype="multipart/form-data" method="post">
                    @csrf
                    <div class="row justify-content-center mb-3">
                            ...
                            <div class="card">
                                ...
                                <div class="card-body card-block">
                                    ...
                                    <div class="form-group">
                                        <label for="name" class="form-control-label">Name <span class="required-field">*</span></label>
                                    ...
                                    <div class="form-group">
                                        <label for="contact_number" class="form-control-label">Contact Number <span class="required-field">*</span></label>
                                    ...
                                    <div class="form-group">
                                        <label for="vehicle_type">Vehicle Types <span class="required-field">*</span></label>
                        ...
                        <div class="col-xl-8 col-lg-8 col-md-12 col-sm-12">
                            <button type="submit" class="btn btn-primary w-100 mx-auto">Create Courier</button>
                        </div>
                    </div>
